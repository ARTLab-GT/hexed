...
class Accessible_mesh : public Mesh
{
  ...
  virtual void connect_hanging_deformed(int coarse_ref_level, int coarse_serial, std::vector<int> fine_serial, Con_dir<Deformed_element>, std::array<bool, 2> stretch = {false, false});
