...
class Solver
{
  ...
  void set_art_visc_smoothness(int projection_row_size, double advect_length, double shift = .5, double diff_ratio = 0., double visc_mult = 2., double stability_ratio = .8, double diff_stab_rat = .8);
