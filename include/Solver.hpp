...
class Solver
{
  ...
  void set_art_visc_smoothness(int projection_row_size, double advect_length, double shift = .5, double diff_ratio = 5e-3, double visc_mult = 5e-2, double stability_ratio = .9, double diff_stab_rat = .8);
