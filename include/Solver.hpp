...
class Solver
{
  ...
  bool is_local_time;
  std::shared_ptr<pde::Transport_model> dyn_visc;
  std::shared_ptr<pde::Transport_model> therm_cond;
  ...
  Solver(int n_dim, int row_size, double root_mesh_size, bool local_time_stepping = false,
         std::shared_ptr<pde::Transport_model> dyn_visc_model = pde::inviscid(),
         std::shared_ptr<pde::Transport_model> therm_cond_model = pde::inviscid());
