...
class Solver
{
  ...
  void set_art_visc_smoothness(int projection_row_size, double scale, double advect_length, double shift = .5, double diff_time = 0., double stability_ratio = .8, double diff_stab_rat = .8);
