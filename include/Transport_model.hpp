...
const auto air_const_therm_cond = Transport_model::constant(1.81206e-5*1.4*specific_gas_air/.4/.71); //!< always returns thermal conductivity of dry air at standard sea level
