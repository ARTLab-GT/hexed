...
double max_dt_eikonal(Kernel_mesh mesh, Kernel_options opts, double msc, double msd, double smoothing, double grad_smoothing, double base_diff) {
  bool calc_ts_ratio = false;
  bool local_time = true;
  COMPUTE_MAX_DT(pde::Eikonal, smoothing, grad_smoothing, base_diff)
