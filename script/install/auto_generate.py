r"""! \file auto_generate.py Executed automatically at build_time to generate C++ files.
...
def auto_generate(build_dir, max_row_size):
    calc_digits = 50
    min_row_size = 2
    assert max_row_size >= 2, "Max row size is < 2"
