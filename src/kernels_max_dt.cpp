...
double max_dt_advection(Kernel_mesh mesh, Kernel_options opts, double msc, double msd, bool local_time, int i_node, double advect_length, double node)
  COMPUTE_MAX_DT(pde::Advection, i_node, advect_length, node)
double max_dt_smooth_av(Kernel_mesh mesh, Kernel_options opts, double msc, double msd, bool local_time) COMPUTE_MAX_DT(pde::Smooth_art_visc, 0, 1., 1.)
