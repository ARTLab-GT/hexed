...
double max_dt_advection(Kernel_mesh mesh, Kernel_options opts, double msc, double msd, bool local_time, double advect_length, double node) COMPUTE_MAX_DT(pde::Advection, advect_length, node)
