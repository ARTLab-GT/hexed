...
TEST_CASE("Array") {
  ...
  SECTION("comparisons") {
    ...
    REQUIRE_THAT(arr0.extreme(0, arr1), Catch::Matchers::RangeEquals(std::vector<int>{2, -1, 4}));
    REQUIRE_THAT(arr0.extreme(1, arr1), Catch::Matchers::RangeEquals(std::vector<int>{1, -2, 3}));
  }
}
