...
TEST_CASE("Element_face_connection<Element>")
{
  ...
  REQUIRE(elem1.faces[2] == nullptr);
  {
    ...
    REQUIRE(elem0.faces[3] == con.new_state(0, false));
    REQUIRE(elem1.faces[2] == con.new_state(1, false));
    REQUIRE(con.direction().i_dim == 1);
    REQUIRE(&con.element(0) == &elem0);
    REQUIRE(&con.element(1) == &elem1);
    REQUIRE(con.new_state(0, false) == elem0.faces[3]);
    REQUIRE(con.new_state(1, false) == elem1.faces[2]);
...
TEST_CASE("Element_face_connection<Deformed_element>")
{
  ...
  REQUIRE(elem0.faces[4] == con.new_state(0, false));
  REQUIRE(elem1.faces[3] == con.new_state(1, false));
  ...
  REQUIRE(con.new_state(0, false) == elem0.faces[4]);
  REQUIRE(con.new_state(1, false) == elem1.faces[3]);
...
TEST_CASE("Refined_connection<Deformed_element>")
{
  ...
  {
    {
      ...
      REQUIRE(fine_con.new_state(0, false) == con.refined_face.fine[1]);
      ...
      for (int i_con = 0; i_con < 4; ++i_con) {
        ...
        REQUIRE(c.element(1).faces[5] == c.new_state(1, false));
      }
    }
  ...
  SECTION("reversed")
  {
    ...
    REQUIRE(fine_con.new_state(1, false) == con.refined_face.fine[2]); // note transposed
  ...
  SECTION("stretched")
  {
    ...
    SECTION("stretch dimension 0")
    {
      ...
      REQUIRE(fine_con.new_state(0, false) == con.refined_face.fine[1]);
      REQUIRE(fine_con.new_state(1, false) == elem1.faces[2*0 + 1]);
      REQUIRE(&elem0.vertex(4) == &coarse.vertex(1));
      REQUIRE(&elem1.vertex(5) == &coarse.vertex(5));
    ...
    SECTION("stretch dimension 0 reverse")
    {
      ...
      REQUIRE(&fine_con.element(0) == &elem1);
      REQUIRE(&fine_con.element(1) == &coarse);
      REQUIRE(fine_con.new_state(0, false) == elem1.faces[2*0 + 1]);
      REQUIRE(fine_con.new_state(1, false) == con.refined_face.fine[1]);
      REQUIRE(&elem0.vertex(4) == &coarse.vertex(1));
      REQUIRE(&elem1.vertex(5) == &coarse.vertex(5));
      REQUIRE(&elem0.vertex(6) == &coarse.vertex(3));
      REQUIRE(&elem1.vertex(7) == &coarse.vertex(7));
    ...
    SECTION("stretch both")
    {
      ...
      REQUIRE(&fine_con.element(1) == &coarse);
      REQUIRE(fine_con.new_state(0, false) == elem0.faces[2*0 + 1]);
      REQUIRE(fine_con.new_state(1, false) == con.refined_face.fine[0]);
      REQUIRE(&elem0.vertex(4) == &coarse.vertex(1));
      REQUIRE(&elem0.vertex(5) == &coarse.vertex(5));
      REQUIRE(&elem0.vertex(6) == &coarse.vertex(3));
